...
//
//import com.mafuyu33.vrironman.client.proxy.HistoryVisualizerClientTick;
...
//        list.add(Component.translatable("item.vr_iron_man.history_visualizer.visualizing." + getMode(itemStack).ordinal()));
//        list.add(Component.translatable("item.vr_iron_man.history_visualizer.right_click"));
...
//            player.sendSystemMessage(Component.translatable("item.vr_iron_man.history_visualizer.visualizing." + newMode));
//        }
//    }
//
